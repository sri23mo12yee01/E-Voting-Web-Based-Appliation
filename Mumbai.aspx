<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mumbai.aspx.cs" Inherits="evote.Mumbai" MasterPageFile="~/Master1.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="width: 100%">
        ...
        <tr>
            ...
            <asp:ListItem>VOTE</asp:ListItem>  </asp:RadioButtonList> 
            </td>
        </tr>
        <tr>
            <td style="width: 59px">
